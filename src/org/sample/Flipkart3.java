...
public class Flipkart3 {
	...
	private void flip() throws InterruptedException {
		...
		Thread.sleep(3000);
		WebElement mseOver = driver.findElement(By.xpath("(//img[@class='_396cs4 _3exPp9'])[9]"));
		...
		Thread.sleep(3000);
		WebElement remoteCar = driver.findElement(By.xpath("//a[text()='Remote Control Toys']"));
		remoteCar.click();
	}
	public static void main(String[] args) throws InterruptedException {
		Flipkart3 f = new Flipkart3();
		f.flip();
	}
}
