...
public class GreensTech4 {
	...
	private void green() {
		...
		WebElement mouseOver2 = driver.findElement(By.xpath("//span[text()='RPA (6)']"));
		a.moveToElement(mouseOver2).perform();
		WebElement find = driver.findElement(By.xpath("//span[text()='Blue Prism Certification Training']"));
		find.click();
	}
	public static void main(String[] args) {
		GreensTech4 g = new GreensTech4();
		g.green();
	}
}
