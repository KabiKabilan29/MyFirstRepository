...
public class GreensTech {
	...
	private void green() {
		...
		WebElement mouseOver2 = driver.findElement(By.xpath("//span[text()='Software Testing (12)']"));
		a.moveToElement(mouseOver2).perform();
		WebElement findElement = driver.findElement(By.xpath("//span[text()='Selenium Certification Training']"));
		findElement.click();
	}
